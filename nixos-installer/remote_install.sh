...
ssh root@$target_destination -i ~/.ssh/id_meek "nixos-generate-config"
...
echo "Cloning nix-config to $target_hostname"
ssh root@$target_destination -i ~/.ssh/id_meek <<EOF
