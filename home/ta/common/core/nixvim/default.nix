{ inputs, pkgs, ... }: {
  ...
  programs.nixvim = {
    ...
    plugins.airline = {
      ...
      powerline = true;
      extensions = {
        # TODO nixvim: Figure out tabline extention stuff in nixvim
    ...
    extraPlugins = builtins.attrValues {
      inherit (pkgs.vimPlugins)
        ...
        # thereis also a lightline-ale  pluging/extension for lightline when you get around to it
        ...
        #TODO nixvim: make sure this is working and not conflicting iwth YCM
    ...
    keymaps = [
      ...
      #{
      # disable defaul move to beginning/end of line
      #mode = ["n"];
      #key = "$";
      #action = "<nop>";
      #}
...
# The following are commented out because they are already included in vim-polyglot but incase poly-glot fails I want to be able to quickly enable what I need.
#haskell-vim
#plantuml-syntax
#pgsql-vim
#python-syntax
